...
/** DaoExceptionMapper.java
 *  INFO202 - Milestone1
 *
 *  Maps exceptions to appropriate error messages to
 *  help user or developer easily discover what went wrong.
 *@author Taken from Lab07, part 5.2 
 */
